...
import com.madsnotepad.util.CmdExecute;
import com.madsnotepad.exception.MadsnotepadException;


public class FFMPEGSplitVideo implements SplitVideo {

	public static final String FFMPEG_SPLIT_CMD = "ffmpeg -ss %1$f -i %2$s -t %3$f -acodec copy -vcodec copy -async 1 -y %4$s";
	...
	public void splitVideo(String videoFile, String outputFile, String startOffset, double endDuration) throws MadsnotepadException {
		if (getCmdExecute() == null) {
			throw new MadsnotepadException("CmdExecute not set");
		}
